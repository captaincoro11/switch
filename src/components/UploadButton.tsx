...
const UploadDropZone = ()=>{
    ...
    const [uploadProgress,setUplaodProgress] = useState<number>(0)
    ...
    const startSimulatedProgress = ()=>{
        ...
        const interval = setInterval(()=>{
            ...
            setUplaodProgress((prevProgress)=>{
                if(prevProgress>=95){
    ...
    return (
        <DropZone onDrop={async(acceptedFile)=>{
            setIsUploading(true);
                ...
                <div>
                   <div {...getRootProps()} className="border h-64 m-4 border-dashed border-gray-300 rounded-lg">
                    <div className="flex items-center justify-center h-full w-full">
                        <label htmlFor="dropzone-flex" className="flex flex-col items-center justify-center w-full h-full rounded-lg cursor-pointer bg-gray-50 hover:bg-gray-100 ">
                            <div className="flex flex-col items-center justify-center pt-5 pb-6 ">
                                <Cloud className="h-6 w-6 text-zinc500 mb-2 "/>
